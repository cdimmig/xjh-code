...
class PGAgent(BaseAgent):
    ...
    def train(self, observations, actions, rewards_list, next_observations, terminals):
        ...
        # rewards are unconcatenated 
        # q_values are concatenated like other data
        ...
        # in update() policy and baseline networks are both updated
    ...
    def estimate_advantage(self, obs, q_values):
        ...
        #######################################################################
        # obs q_values are concatenated 
        # baseline is a nural network
        
        if self.nn_baseline:
            #######################################
            # in order to make the baseline closer to estimate_q_values, we use the neural network to predict the deviation
            # then, convert back to the domain of q_value
