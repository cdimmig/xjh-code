...
class BC_Trainer(object):
    ...
    def __init__(self, params):
        ...
        #######################
        ## just a clarificatioin has not start the initial function
        ...
        #######################
        ## self.rl_trainer = RL_Trainer(self.params) set env and training ,network paras etc.etc.
    ...
    def run_training_loop(self):
        ...
        self.rl_trainer.run_training_loop(
            ...
            collect_policy=self.rl_trainer.agent.actor, # actor = policy (neural network in this case)
